...
<table width="90%" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		...
		onchange="allCheck(this)"> <strong>전체선택</strong></td>
...
%>	    
		...
		<tr>
			...
			<td class="td_default" align="center" width="90"><input
				...
				id="CART_AMOUNT<%=num %>" value="<%=gAmount %>" style="text-align: right" maxlength="3"
...
function orderAllConfirm(f){
	f.action="OrderAllAddServlet";
	f.submit();
}

function order(num){
	  location.href="OrderAddServlet?num="+num;
}
...
function delCart(num){
  ...
  function amountUpdate(num){
	  var amount = document.querySelector("#CART_AMOUNT"+num);
	  location.href="CartAmountUpdateServlet?num="+num+"&amount="+amount.value;
  }
