...
<%
	OrderDTO dto = (OrderDTO) request.getAttribute("orderDone");
...
<table width="70%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="td_default" align="center"><b><%= userid %></b> 님의 주문이 안전하게
			처리되었습니다.</td>
	</tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td height="35" class="td_default" align="center"><span><%= gPrice*gAmount%></span>원
					</td>
				</tr>
			...
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="td_default" height="35" align='right'><input
						type='text' id='total' value='<%= gPrice*gAmount %>' readonly>원</td>
				</tr>
				<tr>
